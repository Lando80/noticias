...
<head>
    ...
    <title>CFormulário de Notícias</title>
        ...
        @csrf
            ...
            <div class="form-group">
                ...
                <textarea   name="conteudo"
                            ...
                            rows="5" 
                            class="form-control">{{$noticia->conteudo}}</textarea>
            </div>

            <div class="form-group">
                <label for="imagem">Alterar a Imagem</label><br>
                <input type="file" name="imagem">
                <div>
                    <img src="{{ $noticia->imagem}}" alt="" heigth="100px">
                </div>
            </div>
